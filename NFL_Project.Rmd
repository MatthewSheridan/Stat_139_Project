...
```{r, warning=F, echo=F}
lm1 = lm(Score_Dif~. , data=data_2017_19[,seq(2, ncol(data_2017_19))])

RF1 = randomForest(Score_Dif~., data=data_2017_19[,seq(2, ncol(data_2017_19))])

step1 <- step(lm(Score_Dif~1, data=data_2017_19), scope=formula(lm1), direction="forward",trace=0)
```
