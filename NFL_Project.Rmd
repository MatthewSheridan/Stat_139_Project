...
sqrt(mean((data_2021$Score_Dif-predict(lm1, newdata = data_2021[,seq(2, ncol(data_2021))]))^2))

boxplot(Score_Dif~Pen, data=data_2019)

plot(Score_Dif~INT, data=data_2019)
plot(Score_Dif~FUM, data=data_2019)
plot(Score_Dif~Rush_Yrd, data=data_2019)
plot(Score_Dif~Pass_Yrd, data=data_2019)

plot(Score_Dif~`3rd_Dwn_Con`, data=data_2019)
plot(Score_Dif~`4th_Dwn_Con`, data=data_2019)
```