...
win.log = glm(wins~.-Score_Dif-Game_id-Team_Name-year, data=data_2017_19_test)

summary(win.log)

rush = seq(min(data_2017_19_test$Rush_Yrd), max(data_2017_19_test$Rush_Yrd), len=100)

res = summary(win.log)$coefficients[1,][1] + summary(win.log)$coefficients[6,][1]*rush

pred=(exp(res)/(1+exp(res)))

plot(data_2017_19_test$wins~data_2017_19_test$Rush_Yrd)
points(pred~rush, col="Green", lw=3)
```
